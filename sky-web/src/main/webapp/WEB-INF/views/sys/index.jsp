            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-table"></i> <span class="nav-label">基础页面样式</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/table_bootstrap.html">表格</a></li>
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/modal_window.html">模态窗口</a></li>
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/form_basic.html">基本表单</a></li>
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/sweetalert.html">SweetAlert</a></li>
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/multiple_table_bootstrap.html">多个表格</a>
                        </li>
                        <li><a class="J_menuItem" href="<%=basePath%>/UI/sky/toastr_notifications.html">Toastr通知</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<script src="<%=basePath%>/UI/sky/js/jquery.min.js"></script>
