            ...
            <div class="col-sm-12">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button id="closeUpdate" type="button" class="close" data-dismiss="modal"><span
                                        aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <h1 class="modal-title">修改</h1>
                            </div>
                            <div class="modal-body">
                                <div class="ibox-content">
                                    <iframe id="updateIframe" class="J_iframe" name="iframe0" width="100%" height="100%"
                ...
                <div class="modal inmodal fade" id="create" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button id="closeCreate" type="button" class="close" data-dismiss="modal"><span
                                        aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            ...
                            <div class="modal-body">
                                <div class="ibox-content">
                                    <iframe id="createIframe" class="J_iframe" name="iframe0" width="100%" height="100%"
                                            src="${pageContext.request.contextPath}/create/${tableNameEN}"
