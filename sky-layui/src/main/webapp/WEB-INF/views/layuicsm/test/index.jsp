...
<head>
    ...
    <link rel="icon" href="${basePath}/UI/test/layuicms2.0/favicon.ico">
    <link rel="stylesheet" href="${basePath}/UI/test/layuicms2.0/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="${basePath}/UI/test/layuicms2.0/css/index.css" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${basePath}/UI/test/layuicms2.0/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${basePath}/UI/test/layuicms2.0/page/login/login.html" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${basePath}/UI/test/layuicms2.0/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${basePath}/UI/test/layuicms2.0/page/main.html"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${basePath}/UI/test/layuicms2.0/layui/layui.js"></script>
<%--<script type="text/javascript" src="${basePath}/UI/test/layuicms2.0/js/index.js"></script>--%>
<script type="text/javascript" src="${basePath}/UI/test/layuicms2.0/js/cache.js"></script>
<script type="text/javascript">

    var $,tab,dataStr,layer;
    layui.config({
        base : "${basePath}/UI/test/layuicms2.0/js/"
    }).extend({
        "bodyTab" : "bodyTab"
    })
    ...
    layui.use(['bodyTab','form','element','layer','jquery'],function(){
        ...
        tab = layui.bodyTab({
            ...
            url : "${basePath}/UI/test/layuicms2.0/json/navs.json" //获取菜单json地址
        });
    ...
    function donation(){
        layer.tab({
            ...
            tab : [{
                title : "微信",
                content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='${basePath}/UI/test/layuicms2.0/images/wechat.jpg'></div>"
            },{
                title : "支付宝",
                content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='${basePath}/UI/test/layuicms2.0/images/alipay.jpg'></div>"
            }]
        })
    }
    ...
    //图片管理弹窗
    function showImg(){
        $.getJSON('${basePath}/UI/test/layuicms2.0/json/images.json', function(json){
            var res = json;
            layer.photos({
                photos: res,
                anim: 5
