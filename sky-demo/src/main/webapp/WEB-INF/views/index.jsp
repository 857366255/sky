...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul id="menu-ul" class="layui-nav layui-nav-tree"  lay-filter="menu">
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">基本元素</a>
                    <dl class="layui-nav-child">
                        <dd><a data-url="${basePath}/basic/button">按钮</a></dd>
                        <dd><a data-url="${basePath}/basic/form">表单</a></dd>
                        <dd><a data-url="${basePath}/basic/tab">选项卡</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
