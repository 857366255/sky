...
<c:set var="typePath" value="supplies"/>
<html>
...
<form:form class="layui-form" action="${basePath}/${typePath}/edit" method="POST" modelAttribute="supplies" >
    <c:if test="${supplies.id != null }">
        <form:hidden path="id" />
    ...
    <div class="layui-form-item">
        <fieldset class="layui-elem-field">
            <legend>类型</legend>
            <form:input lay-verify="title" autocomplete="off" placeholder="请输入" type="text" path="type" class="layui-input layui-field-box" ></form:input>
        </fieldset>
    </div>
    <div class="layui-form-item">
