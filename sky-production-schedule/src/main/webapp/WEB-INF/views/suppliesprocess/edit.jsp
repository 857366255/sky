...
<c:set var="typePath" value="suppliesprocess"/>
<html>
...
<form:form class="layui-form" action="${basePath}/${typePath}/edit" method="POST" modelAttribute="suppliesprocess" >
    <c:if test="${suppliesprocess.id != null }">
        <form:hidden path="id" />
        <input type="hidden" name="_method" value="PUT" />
    </c:if>
    <fieldset class="layui-elem-field">
        <legend>产品名称</legend>
        <form:select items="${suppliess}"  lay-verify="required" itemLabel="name" itemValue="id"  path="suppliesid"  class="layui-field-box" ></form:select>
