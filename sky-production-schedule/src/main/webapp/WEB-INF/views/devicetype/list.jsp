...
<div class="layui-row">
    <div class="layui-col-xs3">
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                <table id="devicetype" lay-filter="devicetype"></table>
            </div>
        </fieldset>
    </div>
    <div class="layui-col-xs*">
        <fieldset class="layui-elem-field">
            <legend>设备信息</legend>
            <div class="layui-field-box">
                <table id="devicecapacitydetail" lay-filter="devicecapacitydetail"></table>
            </div>
        </fieldset>
...
<script>
    layui.use(['table','layer','form'], function(){
        ...
        function renderDevicecapacitydetail() {
            table.render({
